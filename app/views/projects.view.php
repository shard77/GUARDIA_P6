  ...
  <body class="bg-gray-200 font-sans">
    <nav class="bg-white shadow-md rounded-md">
      <div class="container mx-auto px-4 py-2 flex items-center justify-between">
        ...
        <div>
          <a href="<?php echo ROUTE;?>home" class="px-4 py-2 font-bold text-gray-900 rounded-full hover:bg-gray-300 focus:outline-none focus:shadow-outline-blue active:bg-gray-800">Home</a>
    ...
    <div class="container mx-auto px-4">
      <main>
        <div class="py-4">
        <h1 class="text-black text-xl font-semibold mt-5">All Posts:</h1>
