...
<body class="bg-gray-200">
  <nav class="bg-white shadow-md rounded-md">
    <div class="container mx-auto px-4 py-2 flex items-center justify-between">
      ...
      <div>
          ...
          <a href="projects" class="px-4 py-2 font-bold text-gray-900 rounded-full hover:bg-gray-300 focus:outline-none focus:shadow-outline-blue">Projects</a>
          <?php
  ...
  <div class="container mx-auto px-4 py-8">
    <div class="flex items-center mb-4">
      <img src="<?=ROUTE;?>assets/img/base_avatar.webp" alt="Profile Picture" class="w-12 h-12 rounded-full mr-4">
      <div>
